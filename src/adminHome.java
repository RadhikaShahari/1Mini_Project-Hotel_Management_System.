...
public class adminHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setFont(new java.awt.Font("Avignon Pro Medium", 1, 18)); // NOI18N
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(943, 39, -1, -1));

        jButton2.setFont(new java.awt.Font("Avignon Pro Medium", 1, 18)); // NOI18N
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1168, 39, -1, -1));

        jTextField2.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(427, 177, 293, -1));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 177, -1, -1));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1119, 177, -1, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 250, 1310, 493));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/YELLOW15.jpg"))); // NOI18N
        jLabel2.setText("jLabel2");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -110, 1460, 990));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        String nameOrExit=jTextField2.getText();
        ResultSet rs=Select.getData("select *  from users where name like '%"+nameOrExit+"%'or email like '%"+nameOrExit+"%' ");
        DefaultTableModel model=(DefaultTableModel)jTable1.getModel();
        model.setRowCount(0);
        try {
            while(rs.next())
